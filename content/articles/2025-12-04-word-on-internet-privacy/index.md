---
title: "A word on internet privacy"
slug: "word-on-internet-privacy"
categories: ["Industry"]
...
I recently found that people fall into the illusion that all these dancing popups that block your sight from reading articles, news, and other sites, with some bullshit title stating "We value your privacy, please set your choice," and that pressing reject will stop them from tracking you. But there's always a tiny asterisk saying (we will store only necessary anonymous data to keep our product improving). But the thing is, your **cookies** persist between site visits, and Google and other companies already put some data that can help identify you (but yes, it's so-called "anonymous" data – nowhere does it state that you are, for example, *Evgeny Zhdanov* and you're interested in programming and drinking beer).

However, that's only half of the truth. It's not just your name that's stated — all other information you've googled before is already available in **cookies** (with some fingerprints of course), which are used for showing you the correct ads and suggesting proper sites you might be interested in.
...
I never knew this could be a problem to anyone, except to pretend that they actually can do anything and show their anger.
I believe the best illustration of this situation is the following from this AI-generated[^4] landing page (done by [Jimmy Koppel](https://x.com/jimmykoppel) just for fun)

{{< quote author="vibe-coded.lol" citeCaption="We value your privacy (not really)" >}}
We Value Your Privacy (Not Really)
<br />
...
[^3]: https://kagi.com/
[^4]: https://vibe-coded.lol/
[^5]: https://github.com/arp242/goatcounter
[^6]: https://fee.org/articles/have-consumers-already-lost-the-online-privacy-war/
